            ...
            <form action="{{ route('boutiques.update', $boutique->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description[am]" rows="3">{{ $boutique->description['am'] }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="description">Description EN</label>
                        <textarea class="form-control" id="description" name="description[en]" rows="3">{{ $boutique->description['en'] }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="description">Description RU</label>
                        <textarea class="form-control" id="description" name="description[ru]" rows="3">{{ $boutique->description['ru'] }}</textarea>
                    </div>
                    @if ($boutique->image)
